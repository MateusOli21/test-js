...
LoadCheckoutPaymentContext(function (Checkout, PaymentOptions) {
  ...
  //       alert('TESTE CLICK CHO PRO')
  //   })

  //     choPro.addEventListener('load', function () {
  //       console.log('TESTE CLICK CHO PRO')
  //       alert('TESTE LOAD CHO PRO')
  //   })

  //       choPro.addEventListener('resize', function () {
  //       console.log('TESTE CLICK CHO PRO')
  //       alert('TESTE RESIZE CHO PRO')
  //   })

  // choPro.addEventListener('mouseover', function () {
  //       console.log('TESTE CLICK CHO PRO')
  //   alert('TESTE MOUSEOVER CHO PRO')
  //   })


  //   choCard.addEventListener('click', function () {
  //       console.log('TESTE CLICK CHO CARD')
  //     alert('TESTE CLICK CHO CARD')
  //   })

  let root = document.querySelector('#root')
  root.addEventListener('click', function () {
      console.log('TESTE CLICK CHO PRO')
    // alert('TESTE CLICK ROOT')
