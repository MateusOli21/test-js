...
LoadCheckoutPaymentContext(function (Checkout, PaymentOptions) {
  ...
  let installmentsEle = document.createElement('div')
  installmentsEle.className = 'payment-item-discount text-small-extra'
  let spanEle = document.createElement('span')
  let text =
    Checkout.getData('country') == 'BR'
      ? 'Até 6 parcelas sem juros'
      : 'Hasta 6 meses sin interés'
  spanEle.appendChild(document.createTextNode(text))
  installmentsEle.appendChild(spanEle)
  let choproHeader = document
    .querySelector('#radio-option-mercado_pago_checkout_card')
    .querySelector('.accordion-section-header-label')
  choproHeader.appendChild(installmentsEle)
  // const myEvent = new CustomEvent("installments", {
  //   detail: {
  //     card: Checkout.getData(TRANSPARENT_CARD_PAYMENT_ID)
  //   },
  //   bubbles: true,
  //   composed: true
  // })
