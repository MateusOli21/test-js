...
// f3985e82-92d1-4d0e-9c47-50606e3410ce
...
LoadCheckoutPaymentContext(function (Checkout, PaymentOptions) {
  ...
  const checkoutProPaymentOption = PaymentOptions.ModalPayment({
    ...
    onSubmit: async function (callback) {
      ...
      //   }
      // );
      const modalUrl = "https://www.mercadopago.com.ar/checkout/v1/redirect?pref_id=1257655446-602ec3e5-b43e-4b0c-991e-cee777e9dd08"
      const iframeData = { id: "teste-modal", className: "teste-modal", src: modalUrl };
      const iframeConfigs = { showBackDrop: false };
      this.createModal(iframeData, iframeConfigs);
      // mp.checkout({
      //   preference: {
      //     id: "f3985e82-92d1-4d0e-9c47-50606e3410ce",
      //   },
      //   render: {
