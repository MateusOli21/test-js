...
<div id="mp-modal" class="modal-wrapper">
    <div class="modal-content animate-top">
      ...
      <a id="cta-link" target="_blank" href="https://mercadolibre.atlassian.net/wiki/spaces/PLU/pages/1965164949/TiendaNube"> Saiba mais agora mesmo!</a>
...
class MercadoPagoModal extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.shadowRoot.querySelector("#cta-link").addEventListener("click", this._dispatchCtaLinkClicked.bind(this));
  }

  disconnectedCallback() {
    this.shadowRoot.querySelector("#modal-close-btn").removeEventListener("click", this._hideModal);
    this.shadowRoot.querySelector("#cta-link").removeEventListener("click", this._dispatchCtaLinkClicked.bind(this));
  }
  ...
  _dispatchCtaLinkClicked() {
    this.shadowRoot.querySelector("#cta-link").dispatchEvent(
      new CustomEvent("cta-link-clicked", {
        composed: true,
        bubbles: true,
      })
    );
